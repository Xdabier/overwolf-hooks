...
function useGameEventProvider(delegate, requiredFeatures, featureRetries, displayLog) {
    ...
    var setRequiredFeatures = react.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var start = react.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, res, success;
...
var useRunningGame = function (shouldDisplayLog) {
    ...
    var _a = react.useState(null), game = _a[0], setGame = _a[1];
...
var useWindow = function (name, shouldDisplayLog, listenToWindowStateChanges) {
    ...
    var _a = react.useState(), owWindow = _a[0], setOwWindow = _a[1];
    var _b = react.useState(), windowState = _b[0], setWindowState = _b[1];
    var bindWindowBehavior = react.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
...
var useDrag = function (currentWindowID, shouldDisplayLog) {
    if (shouldDisplayLog === void 0) { shouldDisplayLog = false; }
    var _a = react.useState(currentWindowID), owWindow = _a[0], setOwWindow = _a[1];
    var _b = react.useState(null), initialMousePosition = _b[0], setMousePosition = _b[1];
    var _c = react.useState(false), isMouseDown = _c[0], setMouseDown = _c[1];
